...
INSERT INTO failure_history
    (event_date, failure_type, severity, component, symptom, root_cause,
     corrective_action, preventive_action, downtime_min, related_features_json, source_type, notes)
VALUES
    ('2026-06-20', 'HDF', 'MEDIUM', 'spindle_bearing',
    ...
    ('2026-06-15', 'OSF', 'MEDIUM', 'spindle_drive',
    ...
    ('2026-06-12', 'PWF', 'HIGH', 'drive_system',
     '구동부 응답 이상과 순간 전류 상승',
    ...
    ('2026-06-07', 'HDF', 'MEDIUM', 'coolant_system',
    ...
    ('2026-06-03', 'SAFETY_INTERLOCK', 'HIGH', 'guard_interlock',
     '가드 도어 인터록 열림 상태 감지',
     '인터록 스위치 접점 불안정',
    ...
    ('2026-05-30', 'HDF', 'LOW', 'coolant_system',
     '쿨런트 유량 저하 경고',
     '필터 오염과 라인 부분 막힘',
